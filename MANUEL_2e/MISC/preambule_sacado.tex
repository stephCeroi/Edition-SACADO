...
error_correction=qrcode.constants.ERROR_CORRECT_L,box_size=2, border=0)
     ...
     if taille==1 :  # grand qrcode
         s=r"""\parbox{3.5cm}"""
     else :
         s=r"""\parbox{1cm}"""
         
     return s+r"""{\begin{center}
\includegraphics{"""+fic+r"}\\{\scriptsize\tt "+urlcourte+r"}\end{center}}"
\end{pycode}

% compilation complete

%\renewcommand{\qr}[1]{\py{qr("#1",1)}} % compilation complete
%utiliser :
%  pdflatex --shell-escape MANUEL_6e.tex ; pythontex MANUEL_6e.tex --interpreter python:python3 ; pdflatex --shell-escape MANUEL_6e.tex


%\renewcommand{\miniqr}[1]{\py{qr("#1",0)}} 
