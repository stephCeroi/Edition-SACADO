...
%%%%%%%%%%%%% EXEMPLES
\newenvironment{Ex}{%
\medskip \begin{tcolorbox}[widget,colback=white,colframe=sacado_blue!95!black,
title= \stepcounter{cpt} Exemple \thecpt.]}
{%
\end{tcolorbox}\par}

\newenvironment{Exs}{%
\medskip \begin{tcolorbox}[widget,colback=white!15,colframe=sacado_blue!95!black,
...
\medskip \begin{tcolorbox}[widget,colback=white,colframe=sacado_blue!95!black,
title= \stepcounter{cpt} Exemple \thecpt. \hfill \qr{#1}]}
{%
\end{tcolorbox}\par}
...
\newenvironment{His}[1]{%
\medskip \begin{tcolorbox}[widget,colback=white!15,colframe=sacado_violet!75,
title= \stepcounter{cpt} Histoire des maths \thecpt. #1 ]}{%
\end{tcolorbox}\par}


%%%%%%%%%%%%% Attention
\newenvironment{Att}[1]{%
\medskip \begin{tcolorbox}[widget,colback=sacado_red!5,colframe=sacado_red!75,
...
\colorbox{white}{ {\footnotesize  \myVariable } }
\end{center}
...
\newenvironment{ExoDec}[7]{% code avant
\tcbset{top=-0.2cm }
\stepcounter{exo}
\def\myVariable{#2}
\begin{tcolorbox}[right=-5mm, enhanced, lifted shadow={0mm}{0mm}{0mm}{0mm}%
