...
%%%%%%%%%%%%% Histoire
\newenvironment{ExoCade}[1][]{%
\vspace{0.4cm}\stepcounter{exo}
\begin{tcolorbox}[enhanced, lifted shadow={0mm}{0mm}{0mm}{0mm}%
{brown!60!white}, attach boxed title to top left={xshift=5mm, yshift*=-3mm}, coltitle=white, colback=white, boxed title style={colback=sacado_violet!100}, colframe=white!75!black,title=\textbf{\theexo. \hfill #1}]}
{%
\end{tcolorbox}
\par}
