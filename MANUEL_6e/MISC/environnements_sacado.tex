...
\raisebox{0.5em}{\textcolor{texte}{\Huge \bf AUTOÉVALUATION - DTL}}
\hfill \raisebox{0.5em}{\textcolor{texte}{\Large \titreChap}}}
}{\newpage\lhead{}}
...
%%%%%%%%%%%%% Propriétés
\newenvironment{Pp}{%
\medskip \begin{tcolorbox}[widget,colback=white!0,colframe=sacado_blue!75!black,
...
%%%%%%%%%%%%% EXEMPLES
\newenvironment{ExCor}{%
\medskip \begin{tcolorbox}[widget,colback=white,colframe=sacado_violet!95!white,
...
%%%%%%%%%%%%% Attention
\newenvironment{Att}{%
\medskip \begin{tcolorbox}[widget,colback=white,colframe=sacado_red,
...
%%%%%%%%%%%%% Vocabulaire
\newenvironment{VocU}{%
\medskip \begin{tcolorbox}[widget,colback=white,colframe=sacado_green,
title= \stepcounter{cpt} Vocabulaire usuel \thecpt.]}
{%
\end{tcolorbox}\par}
...
\newenvironment{ExoCad}[2][]{%
\vspace{0.2cm}\stepcounter{exo}
\begin{tcolorbox}[enhanced, lifted shadow={0mm}{0mm}{0mm}{0mm}%
{brown!60!white}, attach boxed title to top left={xshift=5mm, yshift*=-3mm}, coltitle=white, colback=white, boxed title style={colback=sacado_violet!100}, colframe=sacado_violet!100,title=\textbf{\theexo. \hfill #1 #2}]}
{%
\end{tcolorbox}
\par}
