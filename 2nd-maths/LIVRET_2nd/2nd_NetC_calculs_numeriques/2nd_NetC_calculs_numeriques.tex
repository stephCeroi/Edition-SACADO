...
$A=\dfrac{1}{1+\sqrt5} +\dfrac{1}{1-\sqrt5} = $ \point{1}

$B=\left(1+\sqrt2\right)^2  -\sqrt2 = $ \point{1}
\end{ExoCad}
...
$A=-\dfrac{20}{16} \times \dfrac{4}{17}=$\point{1}

$B=\dfrac{35}{24} \times \dfrac{18}{15}=$\point{1}
\end{ExoCuN}
\end{minipage}
\begin{minipage}{0.5\linewidth}
\begin{ExoCuN}{Calculer.}{43}{1}{0}{0}{0}{0}
...
$C=-\dfrac{-4}{10} \div \dfrac{20}{16}=$\point{1}

$D=\dfrac{12}{11} \div \dfrac{10}{9}=$\point{1}
...
$A=\dfrac{-6 \times ( -5) \times (-12)}{9 \times ( -4) \times 3 \times (-10)}=$\point{3}
...
$A=\dfrac{4}{5} – \dfrac{2}{5} \times \dfrac{3}{8}=$\point{2} 

$B = \dfrac{12}{5} \times \left(\dfrac{3}{4} + \dfrac{7}{4} \right)=$\point{2} 

$C = \dfrac{-\dfrac{1}{4} -\dfrac{2}{3}}{\dfrac{3}{4}+\dfrac{2}{3}}=$\point{2} 
\end{ExoCu}


%Deuxième exo du parcours 1
\begin{ExoCu}{Représenter. Chercher.}{2}{0}{0}{0}{0}{0}
On pose $a=4\times \left(\frac{3}{5}\right)^3 \times \frac{20}{3}$. Démontrer que $\sqrt{a}$ est un nombre décimal.\point{4}
\end{ExoCu}
...
$a= (-4) \times (-4)\times (-4) \times (-4)  =$  \point{1}
 
$b= 5 \times 5\times 5 \times 5 \times 5\times 5 \times 5  =$  \point{1}
\end{minipage}
\vrule
\begin{minipage}{0.48\linewidth}
$c= \dfrac{1}{(-7) \times (-7)\times (-7) \times (-7)\times (-7) \times (-7)}  =$  \point{1}
 
$d= 5^2 \times 5^6  =$  \point{1}
\end{minipage}
\end{ExoCu}
...
Calculer $a= \frac{(-4)^2\times 3^2\times 4^3 }{5^2\times 3^2\times 4^3} $.  \point{4}
...
$B= 6\sqrt{8} + 3\sqrt{2} + 5\sqrt{50}$\point{2}

$C=\frac{2}{\sqrt{2}}$ \point{2}

$D= \frac{5}{4 - \sqrt{3}}$ \point{2} 

$E= \frac{2+\sqrt{3}}{2 - \sqrt{5}} $\point{2}
...
$A=\dfrac{1}{1+\sqrt5} +\dfrac{1}{1-\sqrt5} = $ \point{2}
...
$A=\left( \sqrt3 + 2 \right)^2 $\point{1}


$B=\left( \sqrt3 + \sqrt5 \right)^2 $\point{1}
\end{ExoCdN}
