...
\begin{center}
\fancyqr[height=4cm]{https://1drv.ms/f/s!AkfkVfhjXbc2g4UOLgNYXHPEQ5qdYw?e=pnLQYx}
\medskip
...
\begin{Ex}
Je veux créer le chapitre \textit{Fonctions affines} qui appartient au thème "fonctions", le titre de mon dossier et de mon fichier \textit{.tex} sera : \textit{2nd\_F\_fonctions\_affines}
\end{Ex}

\subsection{Indiquer sur quel chapitre je travaille}
