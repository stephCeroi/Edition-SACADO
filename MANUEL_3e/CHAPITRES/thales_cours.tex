...
On donne les deux triangles $ABC$ et $EFG$ ci-contre. Les droites $(BC)$ et $(EF)$ sont parallèles.
Expliquer pourquoi le théorème de Thalès ne s'applique pas.
...
\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=0.7874015748031495cm,y=0.7874015748031495cm]
\clip(-1.98,0.38) rectangle (8.18,5.);
\draw [line width=2.pt,color=xfqqff] (-1.,1.)-- (3.98,3.5);
\draw [line width=1.2pt,color=xfqqff] (3.98,3.5)-- (5.24,0.98);
\draw [line width=1.2pt,color=xfqqff] (5.24,0.98)-- (-1.,1.);
\draw [line width=1.2pt,color=xfqqff] (0.3748792930203797,1.6902004483034034)-- (7.673900481540933,0.9721990369181381);
\draw [line width=1.2pt,color=xfqqff] (7.673900481540933,0.9721990369181381)-- (5.92,4.48);
\draw [line width=1.2pt,color=xfqqff] (5.92,4.48)-- (0.3748792930203797,1.6902004483034034);
\begin{scriptsize}
\draw [color=xfqqff] (-1.,1.)-- ++(-2.5pt,0 pt) -- ++(5.0pt,0 pt) ++(-2.5pt,-2.5pt) -- ++(0 pt,5.0pt);
\draw[color=xfqqff] (-0.86,1.37) node {$A$};
\draw [color=xfqqff] (3.98,3.5)-- ++(-2.5pt,0 pt) -- ++(5.0pt,0 pt) ++(-2.5pt,-2.5pt) -- ++(0 pt,5.0pt);
\draw[color=xfqqff] (4.12,3.87) node {$B$};
\draw [color=xfqqff] (5.24,0.98)-- ++(-2.5pt,0 pt) -- ++(5.0pt,0 pt) ++(-2.5pt,-2.5pt) -- ++(0 pt,5.0pt);
\draw[color=xfqqff] (5.38,1.35) node {$C$};
\draw [color=xfqqff] (0.3748792930203797,1.6902004483034034)-- ++(-2.5pt,0 pt) -- ++(5.0pt,0 pt) ++(-2.5pt,-2.5pt) -- ++(0 pt,5.0pt);
\draw[color=xfqqff] (0.52,2.07) node {$D$};
\draw [color=xfqqff] (5.92,4.48)-- ++(-2.5pt,0 pt) -- ++(5.0pt,0 pt) ++(-2.5pt,-2.5pt) -- ++(0 pt,5.0pt);
\draw[color=xfqqff] (6.06,4.85) node {$E$};
\draw [color=xfqqff] (7.673900481540933,0.9721990369181381)-- ++(-2.5pt,0 pt) -- ++(5.0pt,0 pt) ++(-2.5pt,-2.5pt) -- ++(0 pt,5.0pt);
\draw[color=xfqqff] (7.82,1.35) node {$F$};
\end{scriptsize}
\end{tikzpicture}
...
\draw[line width=1.2pt,color=qqqqcc] (-0.5757359312880717,-3.) -- (-0.5757359312880715,-2.5757359312880714) -- (-1.,-2.5757359312880714) -- (-1.,-3.) -- cycle; 
\draw[line width=1.2pt,color=qqqqcc] (7.,-2.5757359312880714) -- (6.575735931288071,-2.5757359312880714) -- (6.575735931288071,-3.) -- (7.,-3.) -- cycle; 
\draw [line width=1.2pt,color=qqqqcc] (-4.,-3.)-- (7.,2.);
\draw [line width=1.2pt,color=qqqqcc] (7.,2.)-- (7.,-3.);
\draw [line width=1.2pt,color=qqqqcc] (7.,-3.)-- (-1.,-3.);
\draw [line width=1.2pt,color=qqqqcc] (-4.,-3.)-- (-1.,-3.);
\draw [line width=1.2pt,color=qqqqff] (-1.,-1.6363636363636365)-- (-1.,-3.);
...
\draw [line width=1.2pt] (-3.,1.)-- (6.,1.);
\draw [line width=1.2pt] (-3.,1.)-- (6.,4.);
\draw [line width=1.2pt] (6.,4.)-- (6.,1.);
\draw [line width=1.2pt] (6.,1.)-- (7.48,1.);
\draw [line width=1.2pt] (7.48,1.)-- (7.48,3.98);
\draw [line width=1.2pt] (7.48,3.98)-- (6.,4.);
\draw [line width=1.2pt] (1.,1.)-- (0.996,2.332);
\begin{scriptsize}
...
\draw [line width=1.2pt,color=qqqqff] (-2.,4.)-- (5.,4.);
\draw [line width=1.2pt,color=qqqqff] (5.,4.)-- (0.,-2.);
\draw [line width=1.2pt,color=qqqqff] (0.,-2.)-- (-2.,4.);
\draw [line width=1.2pt,color=dcrutc] (5.,4.)-- (1.31,-0.428);
\draw [line width=1.2pt,color=dcrutc] (1.31,-0.428)-- (-0.524,-0.428);
\draw [line width=1.2pt,color=dcrutc] (-0.524,-0.428)-- (-1.4285714285714286,2.2857142857142856);
\draw [line width=1.2pt,color=dcrutc] (-1.4285714285714286,2.2857142857142856)-- (0.,4.);
\draw [line width=1.2pt,color=dcrutc] (0.,4.)-- (-2.,4.);
\begin{scriptsize}
...
\draw[color=xdxdff] (-0.96,-1.05) node {$C$};
