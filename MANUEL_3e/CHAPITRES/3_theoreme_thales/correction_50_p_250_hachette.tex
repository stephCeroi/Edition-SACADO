...
% Tapuscrit Michel Fréchet et Denis Vergès
...
On considère le triangle AOS.

Le point O appartient à la droite (AB) et Le point S appartient à la droite (AC). 

Les droites (BC) et (OS) sont parallèles. On utilise le théorème de Thalès:
\[
\frac{AB}{AO}=\frac{BC}{OS}\Longleftrightarrow OS = \frac{AO \times BC}{AB} \Longleftrightarrow   h=\frac{3,2+2,3+2,5 \times 1}{3,2}=2,5
\]
 La hauteur de ce cône de sel est $h=2,50$~mètres. 
 
\item Volume du cône $V$:
\[
V=\frac{\pi\times 2,5^2\times 2,5}{3}\simeq 16,3541666667
\]

Le volume du cône $V$ est environ égal à $16~\text{m}^3$
\end{enumerate} 
